          ...
          <div>
            <form class="d-flex" role="search">
              ...
              <?php if ($_SESSION['permisos'][1] == true) { ?>
                <a href="registrarusua.php">Registra Usuario</a>
              <?php } ?>
              <a href="copia.php">copia</a>
            </form>
            <center>
              <table class="table">
                <thead class="bg-info">
                ...
                <tbody>
                  ...
                  while ($datos = $sql->fetch_object()) { ?>
                    <tr>
                      ...
                      <td>
                        <a href="actualizar.php?id=<?= $datos->id_Usuario ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>

                        <a href="usuarios.php?id_Usuario=<?= $datos->id_Usuario ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
