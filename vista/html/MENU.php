        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <?php if ($_SESSION['permisos'][4] == true) { ?>
              <li class="sidebar-item">
                <a class="sidebar-link dropdown-toggle" href="#usuarios" data-toggle="collapse" data-target="#usuarios">
                  <span class="hide-menu">USUARIOS</span>
                </a>
                <ul class="list-unstyled flex-column pl-3 collapse" id="usuarios" aria-expanded="false">
                  <?php if ($_SESSION['permisos'][6] == true) { ?>
                    <li class="sidebar-item"><a class="sidebar-link" href="usuarios.php">Mostrar todos</a></li>
                  <?php } ?>

                  <?php if ($_SESSION['permisos'][1] == true) { ?>
                    <li class="sidebar-item"><a class="sidebar-link" href="registrarusua.php">Crear usuario</a></li>
                  <?php } ?>

                  <li class="sidebar-item"><a class="sidebar-link" href="roles.php">Roles de usuario</a></li>

                  <?php if ($_SESSION['permisos'][33] == true) { ?>
                    <li class="sidebar-item"><a class="sidebar-link" href="nuevorol.php">Crear Rol</a></li>
                  <?php } ?>
            ...
            <?php if ($_SESSION['permisos'][1] == true) { ?>
              <li class="sidebar-item">
                <a class="sidebar-link" href="registrarusua.php" aria-expanded="false">
                  <span>
